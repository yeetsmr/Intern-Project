...
namespace ClientConsole
{
    ...
    class Code
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine("Generating 50 detailed mock tasks... Please wait.");
                ...
                string[] assignees = { "Yiğit", "Ahmet", "Ayşe", "Fatma", "Mehmet", "Can", "Zeynep", "Elif" };
                ...
                for (int i = 1; i <= 50; i++)
                {
                    ...
                    var randomTask = new Tasks
                    {
                        ...
                        AssigneeName = assignees[rnd.Next(assignees.Length)],
                        Category = rnd.Next(9),
                    ...
                    var res = await client.PostAsJsonAsync($"{baseUrl}/create", randomTask);
                    ...
                    {
                        Console.WriteLine($"\nFailed to add task Auto-{i}. Status: {res.StatusCode}");
                    }
                }
